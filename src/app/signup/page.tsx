  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50 dark:bg-slate-950">
      ...
      <div className="hidden md:flex flex-1 relative bg-[#0A0F1C] overflow-hidden flex-col justify-between p-12 lg:p-20 border-r border-slate-800">
        ...
        <div className="relative z-10 max-w-lg mt-auto mb-auto">
          <h1 className="text-4xl lg:text-5xl font-serif font-medium text-white leading-tight mb-6">
            Start your journey to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">mastery.</span>
          </h1>
          <p className="text-slate-400 text-lg leading-relaxed mb-8">
            Create an account to enroll in industry-focused internships, build a stunning portfolio, and accelerate your tech career.
          </p>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 md:p-12 relative overflow-y-auto">
        ...
        <div className="w-full max-w-[420px] mx-auto py-12 md:py-0">
          <div className="mb-10 text-center md:text-left">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight mb-2">Create an account</h2>
            <p className="text-slate-500 dark:text-slate-400">Join thousands of students building their careers.</p>
          </div>
