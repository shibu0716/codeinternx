    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage system alerts and automated messaging.</p>
        </div>
      </div>
      ...
      <Card className="border-slate-200 shadow-sm overflow-hidden">
        <CardContent className="p-12 md:p-24 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-slate-500 max-w-md mx-auto">
            The notification management center is currently being built. Soon you'll be able to send custom alerts to specific cohorts of students directly from here.
          </p>
        </CardContent>
      </Card>
    </div>
