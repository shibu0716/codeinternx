import { BarChart, HardHat } from "lucide-react";
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Platform metrics and cohort performance analysis.</p>
        </div>
      </div>
      ...
      <Card className="border-slate-200 shadow-sm overflow-hidden">
        <CardContent className="p-12 md:p-24 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-slate-500 max-w-md mx-auto">
            Advanced analytics are currently in development. This dashboard will eventually provide key insights into application velocity, drop-off rates, and program success metrics.
          </p>
        </CardContent>
      </Card>
    </div>
