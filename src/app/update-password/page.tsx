...
export const metadata = {
  title: "Update Password | CodeInternX",
};
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50 dark:bg-slate-950">
      ...
      <div className="hidden md:flex flex-1 relative bg-[#0A0F1C] overflow-hidden flex-col justify-between p-12 lg:p-20 border-r border-slate-800">
        <div className="absolute top-[-20%] left-[-10%] w-[70%] h-[70%] bg-emerald-600/20 blur-[120px] rounded-full pointer-events-none" />
        <div className="absolute bottom-[-20%] right-[-10%] w-[70%] h-[70%] bg-blue-600/20 blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="relative z-10 max-w-lg mt-auto mb-auto">
          <h1 className="text-4xl lg:text-5xl font-serif font-medium text-white leading-tight mb-6">
            Secure your <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-400">account.</span>
          </h1>
          <p className="text-slate-400 text-lg leading-relaxed mb-8">
            Create a strong new password to protect your progress and certificates. Make sure you don't use this password anywhere else.
          </p>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 md:p-12 relative">
        ...
        <div className="w-full max-w-[420px] mx-auto">
          <div className="mb-10 text-center md:text-left">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight mb-2">Create New Password</h2>
            <p className="text-slate-500 dark:text-slate-400">Your identity has been verified. Please choose a strong new password.</p>
          </div>
