            ...
            {pipelinePhases.map((phase, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Hacker Terminal */}
                  <div className="mt-auto relative z-10 shrink-0 bg-[#0a0c10] border border-slate-800/80 rounded-xl overflow-hidden shadow-2xl">
                    <div className="flex items-center justify-between px-4 py-2.5 bg-[#161b22] border-b border-slate-800">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[11px] font-mono text-slate-400 font-medium tracking-wide">sys_admin@internx</span>
                      </div>
                    </div>
                    <div className={`p-5 font-mono text-xs md:text-sm ${phase.terminalColor} leading-relaxed`}>
